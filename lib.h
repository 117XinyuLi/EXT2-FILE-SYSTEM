...
#define GDT_START           0           //组描述符起始地址
#define GD_SIZE             32          //组描述符大小是32B
...
#define MAX_FILE_SIZE     (2*1024*1024-512) //文件最大大小
...
static struct dir_entry dir_buf[32] = {0};   // 目录项缓冲区，一个块可以存放32个目录项
